...
abstract class OrderRepository {
  ...
  Future<Either<Failure, order_entity.Order>> placeOrder(order_entity.Order order);
  Future<Either<Failure, order_entity.Order>> updateOrder(order_entity.Order order);
